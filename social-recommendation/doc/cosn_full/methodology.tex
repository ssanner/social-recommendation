...
\label{fig:Features}
\caption{For each user-item, social affinity features\textit{(ASAF/ISAF)} are binary valued features 
which indicates whether anyone from user's social affinity group\textit{(ISAG/ASAG)} liked the given item or not.}
\end{figure}
%#suvash#
