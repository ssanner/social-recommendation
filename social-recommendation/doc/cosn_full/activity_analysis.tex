...
%temporally sychronized.}
 ...
 We also analyse predictiveness of favourites by categories in
    ...
    active features increases but then starts to decrease sharply. This is due to the fact that items
    with large number of active features are likely to be general items, liked by wide variety of users,
    which makes it hard for SAF to make correct prediction. In Fig~\ref{AccuracyVsmembership} we can see that
    , in general, accuracy of SAF increases as number of group memebership, page likes and favourites increase. 
    This indicates that SAF can make better recommendation to those users who actively express their preferences 
    in a social network via group memebership, page likes and favourites.
