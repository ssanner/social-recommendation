...
Our objective functions has three key features that address 
the main drawbacks of existing algorithms.
Namely, we fully exploit feature-based user similarity, our framework 
permit direct learning of user-to-user information diffusion, 
and is able to learn restricted user interests by leveraging 
co-preference and (dis)agreement.
