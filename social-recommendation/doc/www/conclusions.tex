% Note the use of link features in 4.2.2. with feature-based regularization
% and prediction... this is why copref outperforms 
...
User feedback has opened up many new possibilities for further improving 
...
%devising active learning
%strategies to better explore the social recommendation space.
