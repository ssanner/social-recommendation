...
\begin{figure*}[t!]
\centering
\subfigure{\includegraphics[scale=0.12]{img_new/clicked-likes.eps}}
\hspace{-4mm}
\subfigure{\includegraphics[scale=0.12]{img_new/description-clicked.eps}}
\hspace{-4mm}
\subfigure{\includegraphics[scale=0.12]{img_new/description-liked.eps}}
\hspace{-4mm}
