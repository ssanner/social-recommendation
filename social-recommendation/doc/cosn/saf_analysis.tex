...
we add suffix ISAF and ASAF respectively to NB, LR and SVM models. We train model using
...
the interaction and activities SAGs.Returning to our conjecture that data 
sparsity can hurt SAF, we note from Table~\ref{tab:interests} that page 
likes are more prevalent than groups and favourites. Moreover, these 
results may indicate that there is more social affinity between users having same page likes
...
user $u_2$, regardless of different modality, action and direction.
