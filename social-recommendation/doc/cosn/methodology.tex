...
We define  {\em social affinity groups} (SAG) for user $u$ as a set of other users based on their interactions and activity with user $u$.\\
...
We append additional feature to Interaction features which encodes whether the target item $i$ is liked by friend or not.
