...
\centering
\begin{tabular}{ccc}
\subfloat[Fig:][]{\includegraphics[width=140mm, height=37mm]{data/plots/new/CEvsSize.eps}}\\
%\vspace{-10mm}
\subfloat[Fig:][]{\includegraphics[width=140mm, height=37mm]{data/plots/new/LRWeightsvsSize.eps}}\\
\end{tabular}
\vspace{-2mm}
