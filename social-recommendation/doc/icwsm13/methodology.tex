...
As illustrated in Fig~\ref{fig:overview}, the high-level objective of this paper is predict whether or not a user $u$ will like a digital item $i$ (in our test case, a link). 
