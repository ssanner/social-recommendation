...
\begin{figure*}
\centering
\includegraphics[width=200mm, height=50mm]{data/plots/accuracy/accuracy.eps}
\caption{ Accuracy of predictors (constant, social matchbox, naive bayes, logistic regression, SVM) for interaction and activity (groups, pages and favourites) features }
\label{Fig:1}
\end{figure*}
...
\caption{Conditional entropy breakdown by favourites categories}
\label{Fig:2}
\end{figure*}
...
\centering
\begin{tabular}{ccc}
\subfloat[Fig:][]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/vssize/CEvsGroupSizeEgo.eps}}
\subfloat[Fig:][]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/vssize/CEvsPageSize.eps}}
\subfloat[Fig:][]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/vssize/CEvsFavSize.eps}} \\
\subfloat[Fig:][]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/LRweights/LRweightvsGroupSize.eps}}
\subfloat[Fig:][]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/LRweights/LRweightvsPageSize.eps}}
\subfloat[Fig:][]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/LRweights/LRweightvsFavouriteSize.eps}} \\
\end{tabular}
\caption {fig a-c: conditional entropy vs size, fig d-f: logistic regression feature weights vs size }
\label{Fig:3}
\end{figure*}
...
\centering
\begin{tabular}{ccc}
\subfloat[Fig: Cumulative Conditional Entropy vs Group size][Cumulative conditional entropy\\ vs group size \\(30 bins top 300)]{\includegraphics[scale=0.25]{data/plots/cumulativeEntropy/CEvsGroupSize_Top300Features_30bins.eps}}
\subfloat[Fig: Cumulative Conditional Entropy vs Page size][Cumulative conditional entropy\\ vs page size \\(3000 bins top 800)]{\includegraphics[scale=0.25]{data/plots/cumulativeEntropy/CEvsPageSize_Top800Features_3000bins.eps}}
\subfloat[Fig: Cumulative Conditional Entropy vs Favourite size][Cumulative Conditional entropy\\ vs favourite size \\(5000 bins top 800)]{\includegraphics[scale=0.25]{data/plots/cumulativeEntropy/CEvsFavSize_Top800Features_5000bins.eps}}
\end{tabular}
\label{Fig:4}
\end{figure*}
...
\begin{figure*}
\centering
\includegraphics[width=180mm, height=40mm]{data/plots/vsk/ModalityActionsvsKFriends.eps}
\caption{Conditional entropy breakdown by favourites categories}
\label{Fig:5}
\caption{Conditional Entropy of liking an item given Modalities/Activities constrained to the item liked by atleast k friends}
\end{figure*}
