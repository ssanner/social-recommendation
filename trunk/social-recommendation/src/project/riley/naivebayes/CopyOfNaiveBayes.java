...
public class CopyOfNaiveBayes /*extends Classifier*/ {
	...
	public CopyOfNaiveBayes(double dirichlet_prior) {
	...
	public static void main(String args[]) {
		...
		for (int i = 0; i < iterations; i++){
			...
			CopyOfNaiveBayes nb = new CopyOfNaiveBayes(1.0d /* prior counts */);
			nb.clear();
