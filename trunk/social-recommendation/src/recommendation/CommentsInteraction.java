...
public class CommentsInteraction {

	private Map<Long,Set<Long>> _interactions = null;
	
	public CommentsInteraction() {
	...
	public void addAllInteractions(CommentsInteraction i) {
	...
	public void removeAllInteractions(CommentsInteraction i) {
		for (Map.Entry<Long,Set<Long>> e : i._interactions.entrySet()) { // i's keyset
			long uid = e.getKey();
	...
	public void retainAllInteractions(CommentsInteraction i) {
	...
	public static void main(String[] args) {
		CommentsInteraction i = new CommentsInteraction();
