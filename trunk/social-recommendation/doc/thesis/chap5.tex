...
In the second trial, the Spectral Matchbox approach achieve a larger number of likes compared to the other algorithms. It had 10 more likes compared to the second place algorithm, Spectral Co-preference. On top of this, Spectral Matchbox also had the second lowest number of dislikes among the four algorithms, and was the only algorithm to have more likes than dislikes. Because it had the best ratio of likes to dislikes, we consider Spectral Matchbox to be the best performing algorithm during this round of live trials.
