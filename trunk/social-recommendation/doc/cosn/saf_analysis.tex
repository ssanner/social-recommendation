...
more interactions. 
%To make a distinction between Interaction and Activity based SAF, we add a suffix ISAF and ASAF respectively to NB, LR and SVM \eat{as shown in Fig~\ref{Fig1}}. 
