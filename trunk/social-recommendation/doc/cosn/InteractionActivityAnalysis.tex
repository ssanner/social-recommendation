...
Fig \ref{Fig3} shows the relationship between conditional
    entropy and the size\footnote{For public activities ({\em Pages} and 
    {\em Favorites}), size refers to the total number of facebook user in activity group, whereas
    for {\em Groups} (generally private) it is the total number of user in App 
    user's ego network.} of activity groups. In Fig \ref{Fig3} we clearly observe that the activity groups of small 
    size can be highly predictive whereas large groups are rarely predictive.
    Furthermore, In Fig~\ref{Fig4} we plot the average conditional entropy of the top
...
Here we observe that the informativeness of features varies over interactions and activities.
Unlike state-of-the art social recommenders, SAF classifiers captures this variation by 
weighting the fine-grained features while making prediction 
...
\begin{figure*}[tbp!]
\centering
\includegraphics[width=160mm,height=35mm]{data/plots/cumulativeEntropy/CumulativeCEvsActivity.eps}
...
\begin{figure*}[tbp!]
\centering
\includegraphics[width=160mm, height=35mm]{data/plots/boxPlots/CEvsFavTypesLarge.eps}
