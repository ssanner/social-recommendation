...
10,000+ {\em favourite} features as detailed in
...
above, we define two types of {\em social affinity groups} of a user
with a target item, namely \textit{Interaction Social Affinity Groups
