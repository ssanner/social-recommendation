...
refer the reader back to the points outlined at the end of 
Sec~\ref{sec:introduction}.  
Future research directions can examine the
nature of social groups via additional metrics --- e.g., properties
of the social network within SAGs or the activity level of SAGs.
Other work might explore non-binary representations of ASAFs and ISAFs
or SAF-influenced extensions of (social) collaborative filtering approaches like
nearest neighbor or matrix factorization to better exploit
informative fine-grained social interaction and activity features.
