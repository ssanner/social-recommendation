...
notably, RMSE over all combined ordinal user ratings was used for
...
recommendations.  For friend recommendations, the performance of
Soc. Mbox is most notable where it appears that social regularization
...
recommendations --- to do this if the amount of data were doubled,
...
clicks with perfect accuracy, this would lead only to 
...
everyone on average; hence link popularity should not be used too
