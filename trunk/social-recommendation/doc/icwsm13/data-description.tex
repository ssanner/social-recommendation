...
entities(groups, pages and favourites) via membership and liking.
...
We categorize facebook user-to-user and user-to-entities relationship into two broad categories ie \textbf{Interactions} and \textbf{Activities}.
