...
\end{tabular}
\caption{ mutual information  vs size (top k) \\ Sizes are binned in log scale  }
\label{Fig: mutual information  vs size(top k) Box plots}
\end{figure*}
...
\centering
\begin{tabular}{ccc}
\subfloat[Fig: conditional entropy vs group size ][CE vs group size]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/vssize/CEvsGroupSizeEgo.eps}}
\subfloat[Fig: conditional entropy vs page size ][CE vs page size]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/vssize/CEvsPageSize.eps}}
\subfloat[Fig: conditional entropy vs favourite size ][CE vs favourite size]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/vssize/CEvsFavSize.eps}} \\
\subfloat[Fig: conditional entropy vs group size(log) ][CE vs group size]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/vssize/CEvsGroupSizeLog.eps}}
\subfloat[Fig: conditional entropy vs page size(log) ][CE vs page size]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/vssize/CEvsPageSizeLog.eps}}
\subfloat[Fig: conditional entropy vs favourite size(log) ][CE vs favourite size]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/vssize/CEvsFavSizeLog.eps}}\\
\subfloat[Fig: conditional entropy vs group size(ego) ][CE vs group size(ego)]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/vssize/CEvsGroupSizeEgo.eps}}
\subfloat[Fig: conditional entropy vs page size ][CE vs page size(ego)]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/vssize/CEvsPageSizeEgo.eps}}
\subfloat[Fig: conditional entropy vs favourite size(ego) ][CE vs favourite size(ego)]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/vssize/CEvsFavSizeEgo.eps}}
\end{tabular}
...
\centering
\begin{tabular}{ccc}
\subfloat[Fig: mutual information vs group size ][MI vs group size]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/vssize/MIvsGroupSizeEgo.eps}}
\subfloat[Fig: mutual information vs page size ][MI vs page size]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/vssize/MIvsPageSize.eps}}
\subfloat[Fig: mutual information vs favourite size ][MI vs favourite size]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/vssize/MIvsFavSize.eps}} \\
\subfloat[Fig: mutual information vs group size(log) ][MI vs group size]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/vssize/MIvsGroupSizeLog.eps}}
\subfloat[Fig: mutual information vs page size(log) ][MI vs page size]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/vssize/MIvsPageSizeLog.eps}}
\subfloat[Fig: mutual information vs favourite size(log) ][MI vs favourite size]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/vssize/MIvsFavSizeLog.eps}}\\
\subfloat[Fig: mutual information vs group size(ego) ][MI vs group size(ego)]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/vssize/MIvsGroupSizeEgo.eps}}
\subfloat[Fig: mutual information vs page size ][MI vs page size(ego)]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/vssize/MIvsPageSizeEgo.eps}}
\subfloat[Fig: mutual information vs favourite size(ego) ][MI vs favourite size(ego)]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/vssize/MIvsFavSizeEgo.eps}}
\end{tabular}
...
\centering
\begin{tabular}{ccc}
\subfloat[Fig: logistic regression coefficients vs group size ][LR weight vs group size]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/LRweights/LRweightvsGroupSize.eps}}
\subfloat[Fig: logistic regression coefficients vs page size ][LR weight vs page size]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/LRweights/LRweightvsPageSize.eps}}
\subfloat[Fig: logistic regression coefficients vs favourite size ][LR weight vs favourite size]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/LRweights/LRweightvsFavouriteSize.eps}} \\
\subfloat[Fig: logistic regression coefficients vs group size(ego) ][LR weight vs group size (ego)]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/LRweights/LRweightvsGroupEgoSize.eps}}
\subfloat[Fig: logistic regression coefficients vs page size ][LR weight vs page size(ego)]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/LRweights/LRweightvsPageEgoSize.eps}}
\subfloat[Fig: logistic regression coefficients vs favourite size(ego) ][LR weight vs favourite size(ego)]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/LRweights/LRweightvsFavouriteEgoSize.eps}}
\end{tabular}
\caption{ logistic regression feature weights vs size}
\label{Fig: logistic regression feature weight vs size}
\end{figure*}
...
\centering
\begin{tabular}{ccc}
\subfloat[Fig: conditional entropy vs size][CE vs group size(top 500)]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/sortedBySE/CEvsGroupSize.eps}}
\subfloat[Fig: conditional entropy vs size][CE vs page size(top 1000)]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/sortedBySE/CEvsPageSize.eps}}
\subfloat[Fig: conditional entropy vs size][CE vs favourite size(top 800)]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/sortedBySE/CEvsfavSize.eps}} \\
\subfloat[Fig: mutual information vs size][MI vs group size(top 500)]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/sortedBySE/MIvsGroupSize.eps}}
\subfloat[Fig: mutual information vs size][MI vs page size(top 1000)]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/sortedBySE/MIvsPageSize.eps}}
\subfloat[Fig: mutual information vs size][MI vs favourite size(top 800)]{\includegraphics[width=40mm, height=30mm]{data/plots/scatterplots/sortedBySE/MIvsfavSize.eps}}
\end{tabular}
...
\caption{All graph plots Conditional Entropy for Interaction actions vs Interaction modalities by restricting dataset to links liked by atleast K friends. Each graph analyzes different Interaction Directionality  }
\end{figure*}
...
\centering
\begin{tabular}{c}
\subfloat[Fig: Conditional Entropy vs K friends liked link(Incoming)][Conditional Entropy vs atleast K friends likes link for incoming interactions ]{\includegraphics[width=150mm]{data/plots/vsk/IncomingVsK.eps}}\\
\subfloat[Fig: Conditional Entropy vs K friends liked link(Outgoing)][Conditional Entropy vs atleast K friends likes link for outgoing interactions ]{\includegraphics[width=150mm]{data/plots/vsk/OutgoingVsK.eps}}
\end{tabular}
\end{figure*}
